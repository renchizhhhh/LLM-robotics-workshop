...
if __name__ == '__main__':
    ...
    if (rospy is not None) and ('ROS_MASTER_URI' in os.environ or 'ROS_NAMESPACE' in os.environ):
        ...
        options = SimpleNamespace(
            ...
            image_source=rospy.get_param('~image_source', 'frontright_fisheye_image'),
            force_top_down_grasp=rospy.get_param('~force_top_down_grasp', True),
            force_horizontal_grasp=rospy.get_param('~force_horizontal_grasp', False),
            force_45_angle_grasp=rospy.get_param('~force_45_angle_grasp', False),
            force_squeeze_grasp=rospy.get_param('~force_squeeze_grasp', False),
