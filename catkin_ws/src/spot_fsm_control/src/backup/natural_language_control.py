...
- z: [0.55, 0.65] meters height (reduced upper limit for better reach)
...
- WARNING: Keep z-coordinate between 0.55-0.65m for reliable arm positioning. Higher values may cause the arm to reach too far and look unstable.
...
{"op":"stand","height":0.0}
{"op":"aim_hand","x":0.75,"y":0.0,"z":0.60}
