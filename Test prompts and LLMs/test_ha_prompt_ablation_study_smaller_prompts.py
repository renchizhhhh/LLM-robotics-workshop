...
class HAPromptCompressionStudy:
    def __init__(self):
        self.setup_llm()
    ...
    def create_prompt_variants(self) -> List[PromptVariant]:
        """Create systematic prompt variants for compression ablation study"""
        return [
            # Baseline - Full original prompt
            PromptVariant(
                name="full_original",
                ...
                description="Full original prompt (baseline)"
            ),
            
            # Compression Strategy 1: Individual component compression
            PromptVariant(
                name="compressed_individual",
                components=[PromptComponent.COMPRESSED_ROLE, PromptComponent.COMPRESSED_STATE, PromptComponent.COMPRESSED_LAYOUT, PromptComponent.COMPRESSED_SPECS, PromptComponent.COMPRESSED_ACTIONS, PromptComponent.COMPRESSED_RULES, PromptComponent.COMPRESSED_PLANNING, PromptComponent.COMPRESSED_OUTPUT],
                description="All components individually compressed"
            ),
            
            # Compression Strategy 2: Ultra-compressed single component
            PromptVariant(
                name="ultra_compressed",
                components=[PromptComponent.ULTRA_COMPRESSED],
                description="Everything in one ultra-compressed component"
            ),
            
            # Compression Strategy 3: Minimal compressed
            PromptVariant(
                name="minimal_compressed",
                components=[PromptComponent.MINIMAL_COMPRESSED],
                description="Minimal compressed version with only essential info"
            ),
            
            # Compression Strategy 4: Mixed compression (some original, some compressed)
            PromptVariant(
                name="mixed_compression_1",
                components=[PromptComponent.COMPRESSED_ROLE, PromptComponent.CURRENT_STATE, PromptComponent.COMPRESSED_LAYOUT, PromptComponent.COMPRESSED_SPECS, PromptComponent.AVAILABLE_ACTIONS, PromptComponent.COMPRESSED_RULES, PromptComponent.PLANNING_PROCESS, PromptComponent.OUTPUT_FORMAT],
                description="Mixed: compressed role/layout/specs/rules, original state/actions/planning/output"
            ),
            
            PromptVariant(
                name="mixed_compression_2",
                components=[PromptComponent.ROLE_DEFINITION, PromptComponent.COMPRESSED_STATE, PromptComponent.WORLD_LAYOUT, PromptComponent.ROBOT_SPECS, PromptComponent.COMPRESSED_ACTIONS, PromptComponent.RULES, PromptComponent.COMPRESSED_PLANNING, PromptComponent.COMPRESSED_OUTPUT],
                description="Mixed: compressed state/actions/planning/output, original role/layout/specs/rules"
            ),
            
            # Compression Strategy 5: Selective compression of most verbose components
            PromptVariant(
                name="selective_compression",
                components=[PromptComponent.COMPRESSED_ROLE, PromptComponent.CURRENT_STATE, PromptComponent.COMPRESSED_LAYOUT, PromptComponent.ROBOT_SPECS, PromptComponent.COMPRESSED_ACTIONS, PromptComponent.BASIC_RULES, PromptComponent.MOVEMENT_RULES, PromptComponent.ORIENTATION_RULES, PromptComponent.OBJECT_RULES, PromptComponent.ARM_RULES, PromptComponent.PARAMETER_RULES, PromptComponent.COMPRESSED_PLANNING, PromptComponent.OUTPUT_FORMAT],
                description="Selective compression of most verbose components (role, layout, actions, planning)"
            ),
            
            # Compression Strategy 6: Sentence combination tests
            PromptVariant(
                name="combined_sentences_1",
                components=[PromptComponent.ROLE_DEFINITION, PromptComponent.CURRENT_STATE, PromptComponent.WORLD_LAYOUT, PromptComponent.ROBOT_SPECS, PromptComponent.AVAILABLE_ACTIONS, PromptComponent.BASIC_RULES, PromptComponent.MOVEMENT_RULES, PromptComponent.ORIENTATION_RULES, PromptComponent.OBJECT_RULES, PromptComponent.ARM_RULES, PromptComponent.PARAMETER_RULES, PromptComponent.PLANNING_PROCESS, PromptComponent.OUTPUT_FORMAT],
                description="Original components but with combined sentences where possible"
            ),
            
            # Compression Strategy 7: Abbreviation and shorthand
            PromptVariant(
                name="abbreviated",
                components=[PromptComponent.COMPRESSED_ROLE, PromptComponent.COMPRESSED_STATE, PromptComponent.COMPRESSED_LAYOUT, PromptComponent.COMPRESSED_SPECS, PromptComponent.COMPRESSED_ACTIONS, PromptComponent.COMPRESSED_RULES, PromptComponent.COMPRESSED_PLANNING, PromptComponent.COMPRESSED_OUTPUT],
                description="Heavy use of abbreviations and shorthand"
            ),
            
            # Compression Strategy 8: Remove redundant information
            PromptVariant(
                name="no_redundancy",
                components=[PromptComponent.COMPRESSED_ROLE, PromptComponent.CURRENT_STATE, PromptComponent.COMPRESSED_LAYOUT, PromptComponent.COMPRESSED_SPECS, PromptComponent.COMPRESSED_ACTIONS, PromptComponent.MOVEMENT_RULES, PromptComponent.ORIENTATION_RULES, PromptComponent.OBJECT_RULES, PromptComponent.ARM_RULES, PromptComponent.PARAMETER_RULES, PromptComponent.COMPRESSED_PLANNING, PromptComponent.OUTPUT_FORMAT],
                description="Remove redundant information while keeping essential rules"
            ),
            
            # Compression Strategy 9: Bullet point format
            PromptVariant(
                name="bullet_format",
                components=[PromptComponent.COMPRESSED_ROLE, PromptComponent.COMPRESSED_STATE, PromptComponent.COMPRESSED_LAYOUT, PromptComponent.COMPRESSED_SPECS, PromptComponent.COMPRESSED_ACTIONS, PromptComponent.COMPRESSED_RULES, PromptComponent.COMPRESSED_PLANNING, PromptComponent.COMPRESSED_OUTPUT],
                description="Bullet point format for all components"
            ),
            
            # Compression Strategy 10: Technical shorthand
            PromptVariant(
                name="technical_shorthand",
                components=[PromptComponent.COMPRESSED_ROLE, PromptComponent.COMPRESSED_STATE, PromptComponent.COMPRESSED_LAYOUT, PromptComponent.COMPRESSED_SPECS, PromptComponent.COMPRESSED_ACTIONS, PromptComponent.COMPRESSED_RULES, PromptComponent.COMPRESSED_PLANNING, PromptComponent.COMPRESSED_OUTPUT],
                description="Technical shorthand and symbols"
            ),
            
            # Compression Strategy 11: Essential only with compression
            PromptVariant(
                name="essential_compressed",
                components=[PromptComponent.COMPRESSED_ROLE, PromptComponent.COMPRESSED_LAYOUT, PromptComponent.COMPRESSED_ACTIONS, PromptComponent.MOVEMENT_RULES, PromptComponent.ORIENTATION_RULES, PromptComponent.COMPRESSED_OUTPUT],
                description="Essential components only, all compressed"
            ),
            
            # Compression Strategy 12: Progressive compression levels
            PromptVariant(
                name="progressive_compression_1",
                components=[PromptComponent.COMPRESSED_ROLE, PromptComponent.CURRENT_STATE, PromptComponent.WORLD_LAYOUT, PromptComponent.ROBOT_SPECS, PromptComponent.AVAILABLE_ACTIONS, PromptComponent.BASIC_RULES, PromptComponent.MOVEMENT_RULES, PromptComponent.ORIENTATION_RULES, PromptComponent.OBJECT_RULES, PromptComponent.ARM_RULES, PromptComponent.PARAMETER_RULES, PromptComponent.PLANNING_PROCESS, PromptComponent.OUTPUT_FORMAT],
                description="Level 1: Only role compressed"
            ),
            
            PromptVariant(
                name="progressive_compression_2",
                components=[PromptComponent.COMPRESSED_ROLE, PromptComponent.COMPRESSED_STATE, PromptComponent.WORLD_LAYOUT, PromptComponent.ROBOT_SPECS, PromptComponent.AVAILABLE_ACTIONS, PromptComponent.BASIC_RULES, PromptComponent.MOVEMENT_RULES, PromptComponent.ORIENTATION_RULES, PromptComponent.OBJECT_RULES, PromptComponent.ARM_RULES, PromptComponent.PARAMETER_RULES, PromptComponent.PLANNING_PROCESS, PromptComponent.OUTPUT_FORMAT],
                description="Level 2: Role and state compressed"
            ),
            
            PromptVariant(
                name="progressive_compression_3",
                components=[PromptComponent.COMPRESSED_ROLE, PromptComponent.COMPRESSED_STATE, PromptComponent.COMPRESSED_LAYOUT, PromptComponent.COMPRESSED_SPECS, PromptComponent.AVAILABLE_ACTIONS, PromptComponent.BASIC_RULES, PromptComponent.MOVEMENT_RULES, PromptComponent.ORIENTATION_RULES, PromptComponent.OBJECT_RULES, PromptComponent.ARM_RULES, PromptComponent.PARAMETER_RULES, PromptComponent.PLANNING_PROCESS, PromptComponent.OUTPUT_FORMAT],
                description="Level 3: Role, state, layout, specs compressed"
            ),
            
            PromptVariant(
                name="progressive_compression_4",
                components=[PromptComponent.COMPRESSED_ROLE, PromptComponent.COMPRESSED_STATE, PromptComponent.COMPRESSED_LAYOUT, PromptComponent.COMPRESSED_SPECS, PromptComponent.COMPRESSED_ACTIONS, PromptComponent.BASIC_RULES, PromptComponent.MOVEMENT_RULES, PromptComponent.ORIENTATION_RULES, PromptComponent.OBJECT_RULES, PromptComponent.ARM_RULES, PromptComponent.PARAMETER_RULES, PromptComponent.COMPRESSED_PLANNING, PromptComponent.OUTPUT_FORMAT],
                description="Level 4: Role, state, layout, specs, actions, planning compressed"
            ),
            
            # Compression Strategy 13: Different compression approaches
            PromptVariant(
                name="compression_approach_1",
                components=[PromptComponent.COMPRESSED_ROLE, PromptComponent.CURRENT_STATE, PromptComponent.COMPRESSED_LAYOUT, PromptComponent.ROBOT_SPECS, PromptComponent.COMPRESSED_ACTIONS, PromptComponent.BASIC_RULES, PromptComponent.MOVEMENT_RULES, PromptComponent.ORIENTATION_RULES, PromptComponent.OBJECT_RULES, PromptComponent.ARM_RULES, PromptComponent.PARAMETER_RULES, PromptComponent.PLANNING_PROCESS, PromptComponent.COMPRESSED_OUTPUT],
                description="Compression approach 1: Compress role, layout, actions, output"
            ),
            
            PromptVariant(
                name="compression_approach_2",
                components=[PromptComponent.ROLE_DEFINITION, PromptComponent.COMPRESSED_STATE, PromptComponent.WORLD_LAYOUT, PromptComponent.COMPRESSED_SPECS, PromptComponent.AVAILABLE_ACTIONS, PromptComponent.COMPRESSED_RULES, PromptComponent.COMPRESSED_PLANNING, PromptComponent.OUTPUT_FORMAT],
                description="Compression approach 2: Compress state, specs, rules, planning"
            ),
            
            PromptVariant(
                name="compression_approach_3",
                components=[PromptComponent.COMPRESSED_ROLE, PromptComponent.COMPRESSED_STATE, PromptComponent.WORLD_LAYOUT, PromptComponent.ROBOT_SPECS, PromptComponent.COMPRESSED_ACTIONS, PromptComponent.COMPRESSED_RULES, PromptComponent.PLANNING_PROCESS, PromptComponent.COMPRESSED_OUTPUT],
                description="Compression approach 3: Compress role, state, actions, rules, output"
            )
        ]
...
Actions:""",
            ...
            # Compressed variants
            PromptComponent.COMPRESSED_ROLE: "Path planner for Boston Dynamics Spot robot.",
            
            PromptComponent.COMPRESSED_STATE: """State: {current_state} at {current_position}""",
            
            PromptComponent.COMPRESSED_LAYOUT: """Locations: Pick-up (2.0, -1.0, 0.0) yaw=0, Drop-off (2.0, 0.5, 0.0) yaw=1.57""",
            
            PromptComponent.COMPRESSED_SPECS: """Robot: 0.7m×1.4m, body frame (x=forward, y=left, yaw=rotation)""",
            
            PromptComponent.COMPRESSED_ACTIONS: """Actions: stand_up, sit_down, start_moving x=float y=float yaw=float frame=body, start_automated_grasp object_type=name, start_move_arm_pose x y z qw qx qy qz duration open_gripper, start_arm_command open|close|stow|carry""",
            
            PromptComponent.COMPRESSED_RULES: """Rules: Visit destinations in order, one action per line, no quotes, robot must stand before moving/grasping, use exact object names, relative body frame movements (move_x = target_x - current_x), pick-up yaw=0, drop-off yaw=1.57, drop-off procedure: arm_pose→open→close→stow""",
            
            PromptComponent.COMPRESSED_PLANNING: """Plan: Parse destinations→calculate relative movements→visit in order→orient correctly→add drop-off procedure""",
            
            PromptComponent.COMPRESSED_OUTPUT: """Task: {task}\nActions:""",
            
            PromptComponent.ULTRA_COMPRESSED: """Spot robot path planner. State: {current_state} at {current_position}. Locations: Pick-up (2.0, -1.0, 0.0) yaw=0, Drop-off (2.0, 0.5, 0.0) yaw=1.57. Actions: stand_up, sit_down, start_moving x y yaw frame=body, start_automated_grasp object_type, start_move_arm_pose x y z qw qx qy qz duration open_gripper, start_arm_command open|close|stow. Rules: Visit in order, one per line, no quotes, stand first, exact names, relative movements, pick-up yaw=0, drop-off yaw=1.57+arm_pose→open→close→stow. Task: {task}\nActions:""",
            
            PromptComponent.MINIMAL_COMPRESSED: """Spot robot planner. Pick-up (2.0, -1.0, 0.0) yaw=0, Drop-off (2.0, 0.5, 0.0) yaw=1.57. Actions: start_moving x y yaw frame=body, start_automated_grasp object_type, start_move_arm_pose x y z qw qx qy qz duration open_gripper, start_arm_command open|close|stow. Rules: Visit in order, one per line, relative movements, pick-up yaw=0, drop-off yaw=1.57+arm_pose→open→close→stow. Task: {task}\nActions:"""
        }
    ...
    async def run_compression_study(self, num_runs: int = 3) -> List[TestResult]:
        """Run compression study with multiple runs for each combination"""
        results = []
        
        total_tests = len(self.prompt_variants) * len(self.test_tasks) * num_runs
        print(f"Running compression study: {len(self.prompt_variants)} variants × {len(self.test_tasks)} hard task × {num_runs} runs = {total_tests} total tests")
    ...
    def save_results(self, results: List[TestResult], filename: str = "ha_prompt_compression_results.json"):
    ...
    def generate_markdown_table(self, results: List[TestResult], filename: str = "compression_study_results.md"):
        """Generate markdown table with compression study results"""
        ...
        markdown_content = "# HA Prompt Compression Study Results\n\n"
        ...
        markdown_content += f"- **Focus**: Testing different compression strategies to reduce prompt length while preserving performance\n\n"
    ...
    def print_summary(self, results: List[TestResult]):
        ...
        print("\n" + "="*80)
        print("HA PROMPT COMPRESSION STUDY ANALYSIS")
        print("="*80)
...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(description='Run HA prompt compression study')
    ...
    parser.add_argument(
        '--output',
        default='ha_prompt_compression_results.json',
        help='Output file for results (default: ha_prompt_compression_results.json)'
    )
    
    parser.add_argument(
        '--markdown',
        default='compression_study_results.md',
        help='Output markdown file for results table (default: compression_study_results.md)'
    )
    
    return parser.parse_args()

async def main():
    """Main function to run compression study"""
    args = parse_arguments()
    
    print("Starting HA Prompt Compression Study")
    print("="*50)
    ...
    # Create tester and run compression study
    tester = HAPromptCompressionStudy()
    results = await tester.run_compression_study(args.runs)
